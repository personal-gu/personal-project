          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li  class="active"><a href="${pageContext.request.contextPath}/user_goInfo.action">我的参与</a></li>
			...
			<div class="jobs-table">
				<div class="table-header">
					<div class="table-cells flex">
						...
						<div class="job-type-cell"><h6>状态</h6></div>
					...
					<div class="table-cells flex no-wrap">
						...
						<div class="cell job-type-cell flex no-column no-wrap">
							...
							<s:if test="#vo.Volunteer_act_status==0">
								<button type="button" class="button full-time">招募中</button>
							</s:if>
						...
						<!-- <div class="cell salary-cell flex no-column no-wrap">
							<div class="cell-mobile-label">操作
								<h6>Salary</h6>
							</div> end .cell-label
							<p>caozuo</p>
						</div> -->
