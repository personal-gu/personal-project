...
<section>
    <div class="container-fluid">
        <div class="row ">
                ...
                <div class="panel-group sidebar-menu" id="accordion" aria-multiselectable="true">
                    ...
                    <div class="panel panel-default menu-first">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse in">
                            <ul class="nav nav-list menu-second">
                                <li class="menu-second-selected"><a href="${pageContext.request.contextPath}/t_curdAdmint.action"><i class="icon-user"></i> 管理员CURD</a></li>
			...
			<div class="col-xs-10">
				<br />
				<form action="${pageContext.request.contextPath}/t_curdAdmint.action" id="select_form" method="get">
				...
				<select name="select_type" id="select_type" class="form-control line left">
					...
					<option value="admin_dept">管理员类型</option>
				</select>
 ...
 -->
							<tr>
								<td><input type="checkbox" name="admin_uid" value='<s:property value="#vo.admin_uid" />'></td>
								<td><s:property value="#vo.admin_name" /></td>
								<td><s:property value="#vo.admin_p" /></td>
								<td><s:property value="#vo.admin_dept" /></td>
...
<script type="text/javascript">
	...
	function doAdd(){ 
		var url="${pageContext.request.contextPath}/t_addAdmint.action";
		layer.open({
			type:2,
			title:'添加管理员',
			shadeClose:false,
	...
	function doEdit(){
		//修改功能 获取被选择的值 是一个数组
		var temp = new Array();
		temp = $('input[name="admin_uid"]:checked');
		...
		if(temp.length==1){
			var hrEmpData = temp[0].value;
			 window.top.layer.open({
						...
						shade:0.8,
						area:['800px','70%'],
						content:'${pageContext.request.contextPath}/t_editAdmint.action?admin_uid='+hrEmpData,
						btn:['确认','取消'],
		...
		layer.confirm(
			...
			//确认删除 发送一个ajax请求
			 $.ajax({
				...
				dataType:'json',
				data:temps,
				url:"${pageContext.request.contextPath}/t_delAdmint.action",
